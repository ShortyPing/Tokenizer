...
package xyz.shortping.tokenizertest;

import xyz.shortping.tokenizertest.tokens.Tokenizer;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        tokenizer.tokenizeString("printConsole#Hello World!");
        tokenizer.tokenizeString("sum#dfas#2");
    }
